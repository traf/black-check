...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`flex flex-col lg:flex-row h-fit lg:h-screen bg-neutral-950 text-white antialiased selection:bg-white/10 selection:text-white font-mono overscroll-none ${carbon.variable} ${fk.variable}`}>
        <PrivyWrapper>
